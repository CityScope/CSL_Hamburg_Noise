...
road_network_json = os.path.abspath('./input_geojson/design/roads/road_network.json')
buildings_json = os.path.abspath('./input_geojson/design/buildings/buildings.json')

# static input data
upper_main_road_single_line_json = os.path.abspath('./input_geojson/static/roads/upper_main_road_single.json')
upper_main_road_multi_line_json = os.path.abspath('./input_geojson/static/roads/upper_main_road_multi.json')
main_road_lower_multi_line_json = os.path.abspath('./input_geojson/static/roads/lower_main_road_multi.json')
railroad_multi_line_json = os.path.abspath('./input_geojson/static/roads/railroad.json')
...
def get_building_queries():
    data = open_geojson(os.path.abspath('./input_geojson/design/buildings/buildings.json'))
